...
describe('dispatchInboundToAiReply — eligibility gates', () => {
  ...
  it('stands down when an active new_message_received automation exists (fires on every message)', async () => {
    h.state.autoResponders = [
  ...
  it('stands down when an active keyword_match automation matches this message', async () => {
    h.state.autoResponders = [
      {
        id: 'auto-1',
  ...
  it('does NOT stand down when an active keyword_match automation does not match this message', async () => {
    h.state.autoResponders = [
      {
        id: 'auto-1',
        trigger_type: 'keyword_match',
        trigger_config: { keywords: ['send brochure'], match_type: 'contains' },
      },
    ]
    await dispatchInboundToAiReply(ARGS)
